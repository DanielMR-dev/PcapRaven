...
final security and supply-chain hardening is implemented on its dedicated
branch; PR-head CI and final acceptance remain pending. It has no released or
supported software versions yet. Phase 21 is next, future, and not implemented;
Phases 22 through 28 remain future and not implemented. This policy covers
...
Phase 20 dependency, advisory, license, provenance, maintenance, and CI
evidence is recorded in [docs/SUPPLY_CHAIN.md](docs/SUPPLY_CHAIN.md).
