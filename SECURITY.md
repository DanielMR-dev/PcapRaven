...
Phase 7, Phase 8, Phase 9, Phase 10, Phase 11, Phase 12, Phase 13, and Phase 14; it has no released or supported software versions yet. This policy covers
...
periodic beaconing detection, DNS anomaly and possible tunneling detection, repeated low-volume flow behavior detection, cross-detector finding correlation, functional CLI orchestration, remaining workspace skeletons, and future code as it is introduced.
