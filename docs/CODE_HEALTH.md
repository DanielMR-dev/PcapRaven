...
supply-chain hardening is implemented on its dedicated branch; its evidence is
recorded in `docs/SUPPLY_CHAIN.md`, while PR-head CI and final acceptance remain
pending. Phase 21 is next, future, and not implemented; Phases 22 through 28
remain future and not implemented. No Phase 19 feature, release, or later-phase
