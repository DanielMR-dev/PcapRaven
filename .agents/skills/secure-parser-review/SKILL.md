...
2. Confirm parser implementation is allowed. Phase 2 capture parsing, Phase 3
   packet normalization, Phase 7 DNS protocol analysis, Phase 8 HTTP/1.x
   protocol analysis, and Phase 9 TLS handshake metadata analysis are accepted.
   Use `dns-protocol-analysis`, `http-protocol-analysis`, and `tls-protocol-analysis`
   skills for protocol changes. Future phase decoders remain out of scope.
